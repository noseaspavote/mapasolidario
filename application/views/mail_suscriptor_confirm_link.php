  ...
  <tr>
    ...
    <td class="container" bgcolor="#FFFFFF">
      ...
      <table>
        <tr>
          <td>
            <p>Hola <?=$suscriptor_name;?>!,</p>
            <p>Para continuar el alta del a institución, debes confirmar tu cuenta de correo haciendo click en el siguiente link:</p>
            <p><a href="<?=site_url('confirm/' . $confirm_key);?>" title="Confirmar link"><?=site_url('confirm/' . $confirm_key);?></a></p>
			</br>
            <!-- /button -->
            <p>Una vez confirmada tu cuenta, nos podremos en contacto con la institución para confirmar los datos ingresados.</p>
